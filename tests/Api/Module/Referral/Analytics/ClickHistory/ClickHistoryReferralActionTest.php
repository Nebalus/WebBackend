...
class ClickHistoryReferralActionTest extends TestCase
{
    private ClickHistoryReferralService $service;
    private ClickHistoryReferralValidator $validator;
    private ClickHistoryReferralAction $action;

    protected function setUp(): void
    {
        $this->service = $this->createMock(ClickHistoryReferralService::class);
        $this->validator = $this->createMock(ClickHistoryReferralValidator::class);
        $this->action = new ClickHistoryReferralAction($this->service, $this->validator);
    }
