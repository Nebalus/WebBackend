...
class GetAllPermissionActionTest extends TestCase
{
    private GetAllPermissionService $service;
    private GetAllPermissionAction $action;

    protected function setUp(): void
    {
        $this->service = $this->createMock(GetAllPermissionService::class);
        $this->action = new GetAllPermissionAction($this->service);
    }
