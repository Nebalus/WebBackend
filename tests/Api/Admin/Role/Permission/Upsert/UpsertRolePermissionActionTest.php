...
class UpsertRolePermissionActionTest extends TestCase
{
    private UpsertRolePermissionService $service;
    private UpsertRolePermissionValidator $validator;
    private UpsertRolePermissionAction $action;

    protected function setUp(): void
    {
        $this->service = $this->createMock(UpsertRolePermissionService::class);
        $this->validator = $this->createMock(UpsertRolePermissionValidator::class);
        $this->action = new UpsertRolePermissionAction($this->service, $this->validator);
    }
